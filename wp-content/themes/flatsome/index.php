...
<head>
	...
	<link rel="stylesheet" href="./wp-content/themes/flatsome/assets/css/style.css">
	<link rel="stylesheet" href="./wp-content/themes/flatsome/assets/css/animation.css">

	<title>Easy HRM</title>
	<div id="fb-root"></div>
...
<body>
		...
		<div class="container">
			<nav class="navbar navbar-expand-lg" style="height: 100px">
				...
				<a style="width: 125px" class="navbar-brand" href="#">
					<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T03_52_10_563Z.png"
						width="100%" alt="" />
				</a>
				<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarScroll"
					...
					<span class="">
						<img style="width: 20px; height: 20px"
							src="https://easyhrm.vn/wp-content/uploads/2023/09/683459-200.png" alt="" />
					</span>
				</button>
				<div class="collapse navbar-collapse stroke" id="navbarScroll">
					<ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll header-list"
						style="--bs-scroll-height: 100px">
						<li class="categories">
							<a style="color: var(--gray-2, #263856)" class="" href="#">Sản phẩm</a>
						</li>
						<li class="categories">
							<a style="color: var(--gray-2, #263856)" class="" href="#">Khách hàng</a>
						</li>
						<li class="categories">
							<a style="color: var(--gray-2, #263856)" class="" href="#">Cam kết</a>
						</li>
						<li class="categories">
							<a style="color: var(--gray-2, #263856)" class="" href="#">Nhà phân phối</a>
						</li>
						<li class="categories">
							<a style="color: var(--gray-2, #263856)" class="" href="#">Tin tức</a>
						</li>
						<li class="categories">
							<a style="color: var(--gray-2, #263856)" class="" href="#">Liên hệ</a>
						</li>
					</ul>
					...
					<a href="tel:1900545415">
						<button class="hotline-header">1900 54 54 15</button>
					</a>
					<button class="consulation-header">Tư vấn</button>
				</div>
			</nav>
		</div>
	</header>
			...
			<div class="row center-row">
					...
					<div class="row slide-left">
						...
						<div class="col-md-6">
							<div class="statistics">
								...
								<div class="data-explain">tối ưu chi phí quản trị</div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-6 slide-right">
					<img class="banner-picture-right"
						src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_05T09_18_00_228Z.png" alt="" />
				</div>
			</div>
			...
			<div class="row center-row">
				<div class="col-md-6 col-sm-12">
					...
					<div class="hrm-content">
						<span class="backtext">EasyHRM</span> là giải pháp quản lý nhân sự
						toàn diện do Công ty CP Đầu tư & Thương mại Softdreams ra mắt. Sở
						...
						hiện đang có hơn 200.000 đối tác sử dụng.
					</div>
					<button class="loadmore-btn">Xem thêm</button>
				</div>
				<div class="col-md-6 animation_img_right">
					<img style="width: 100%"
						src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_05T03_30_43_512Z.png" alt="" />
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-sm-12">
					<div class="featured-box">
						<div class="featured-icon">
							<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T01_26_38_377Z.png"
								alt="" />
						</div>
				...
				<div class="col-md-4 col-sm-12">
					<div class="featured-box">
						<div class="featured-icon">
							<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T01_26_49_862Z.png"
								alt="" />
						</div>
						<div class="featured-content">
				...
				<div class="col-md-4 col-sm-12">
					<div class="featured-box">
						<div class="featured-icon">
							<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T01_26_55_512Z.png"
								alt="" />
						</div>
						<div class="featured-content">
			...
			<div class="row second-row">
				...
				<div class="col-md-4 col-sm-12">
					<div class="featured-box">
						<div class="featured-icon">
							<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T01_27_01_008Z.png"
								alt="" />
						</div>
						<div class="featured-content">
				...
				<div class="col-md-4 col-sm-12">
					<div class="featured-box">
						<div class="featured-icon">
							<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T01_27_05_148Z.png"
								alt="" />
						</div>
						<div class="featured-content">
	...
	<section id="hrm_management">
		<div class="container">
			...
			<div class="row center-row">
				...
				<div class="col-md-6 animation_img_right">
					<img style="width: 100%"
						src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T02_03_56_685Z.png" alt="" />
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row center-row">
					<div class="col-md-6 animation_img_left">
						<img style="width: 100%"
							src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_06T01_08_29_043Z.png"
							alt="" />
					</div>
					<div class="col-md-6">
		...
		<div class="time-management">
			<div class="container">
				<div class="row center-row">
					...
					<div class="col-md-6 animation_img_right">
						<img style="width: 100%"
							src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T02_32_45_349Z.png"
							alt="" />
					</div>
				</div>
			</div>
	...
	<section id="hrm_banner_seperation">
		<img width="100%" src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_05T09_12_24_121Z.png"
			alt="" />
					...
					<div class="customer-box">
						<div class="customer-info">
							<div class="customer-avt">
								<img style="width: 100%"
									src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T06_33_37_830Z.png"
									alt="" />
							</div>
						...
						<div class="customer-rate">
							<div class="star-rate">
								<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T06_50_59_775Z.png"
									alt="" />
							</div>
							<div class="star-rate">
								<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T06_50_59_775Z.png"
	...
	<section id="hrm_signature_customer">
		<div class="container">
			<div class="hrm-title justify-content-center">
			...
			<div class="brand-list">
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T07_06_39_620Z.png"
						alt="" />
				</div>
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T07_06_44_869Z.png"
						alt="" />
				</div>
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T07_06_48_990Z.png"
						alt="" />
				</div>
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T07_06_53_096Z.png"
						alt="" />
				</div>
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_06T01_56_01_202Z.png"
						alt="" />
				</div>
			</div>
			<div class="brand-list">
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_05T07_55_12_684Z.png"
						alt="" />
				</div>
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_05T07_55_18_221Z.png"
						alt="" />
				</div>
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_05T07_55_23_873Z.png"
						alt="" />
				</div>
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_05T07_55_27_043Z.png"
						alt="" />
				</div>
			</div>
			<div class="brand-list">
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_05T07_55_29_796Z.png"
						alt="" />
				</div>
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_05T07_55_38_693Z.png"
						alt="" />
				</div>
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_05T07_55_42_609Z.png"
						alt="" />
				</div>
				<div>
					<img src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_05T07_55_46_131Z.png"
						alt="" />
				</div>
			</div>
		</div>
	...
	<section id="hrm_price">
		<div class="container">
					...
					<div class="price-quote">
						<div class="price-quote-title text-center">
							<div class="quote-title-icon">
								<img style="width: 100%"
									src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T07_20_52_362Z.png"
									alt="" />
							</div>
			  ...
			  ">
						<div class="price-quote-title text-center">
							<div class="quote-title-icon" style="padding: 6px">
								<img style="width: 100%"
									src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T07_36_56_056Z.png"
									alt="" />
							</div>
				...
				<div class="col-md-4 col-sm-12">
					<div class="price-quote">
						<div class="price-quote-title text-center">
							<div class="quote-title-icon">
								<img style="width: 100%"
									src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T08_04_38_251Z.png"
									alt="" />
							</div>
			...
			<div class="price-detail-showing">
				<div class="showing-title">
					<div class="showing-title-img">
						<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T07_20_52_362Z.png"
							alt="" />
					</div>
					<div class="hrm-ref1">EASYHRM STANDARD</div>
				</div>
				<div class="typeOfHrm center-row">
					...
					<div style="height: 28px; width: 28px">
						<img style="width: 100%; margin-left: 10px; margin-bottom: 10px"
							src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_29T09_28_02_638Z.png"
							alt="" />
					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
						<div class="showing-detail">
							<div class="specific-price">
								589.000 <span class="vnd">VNĐ</span>
							</div>
							<div class="type">
								Gói cước <span class="time">12 tháng</span>
							</div>
							<div class="expired">
								Thời gian sử dụng: <span class="time">18 tháng</span> <br />
								<span class="gift-explain">
									(Đã được tặng thêm 6 tháng sử dụng)
								</span>
							</div>
							<button class="loadmore-btn" style="width: 80%">Tư vấn</button>
						</div>
					</div>
					<div class="col-md-4">
						<div class="showing-detail">
							<div class="specific-price">
								989.000 <span class="vnd">VNĐ</span>
							</div>
							<div class="type">
								Gói cước <span class="time">24 tháng</span>
							</div>
							<div class="expired">
								Thời gian sử dụng: <span class="time">33 tháng</span> <br />
								<span class="gift-explain">
									(Đã được tặng thêm 9 tháng sử dụng)
								</span>
							</div>
							<button class="loadmore-btn" style="width: 80%">Tư vấn</button>
						</div>
					...
					<div class="col-md-4">
						<div class="showing-detail">
							<div class="specific-price">
								1.289.000 <span class="vnd">VNĐ</span>
							</div>
							<div class="type">
								Gói cước <span class="time">36 tháng</span>
							</div>
							<div class="expired">
								Thời gian sử dụng: <span class="time">48 tháng</span> <br />
								<span class="gift-explain">
									(Đã được tặng thêm 12 tháng sử dụng)
								</span>
							</div>
							<button class="loadmore-btn" style="width: 80%">Tư vấn</button>
						</div>
				...
				<div class="typeOfHrm center-row">
					...
					<div style="height: 28px; width: 28px">
						<img style="width: 100%; margin-left: 10px; margin-bottom: 10px"
							src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T08_53_48_648Z.png"
							alt="" />
					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
						<div class="showing-detail">
							<div class="specific-price">
								1.399.000 <span class="vnd">VNĐ</span>
							</div>
							<div class="type">
								Gói cước <span class="time">12 tháng</span>
							</div>
					...
					<div class="col-md-4">
						<div class="showing-detail">
							<div class="specific-price">
								2.399.000 <span class="vnd">VNĐ</span>
							</div>
							<div class="type">
								Gói cước <span class="time">24 tháng</span>
							</div>
					...
					<div class="col-md-4">
						<div class="showing-detail">
							<div class="specific-price">
								2.699.000 <span class="vnd">VNĐ</span>
							</div>
							<div class="type">
								Gói cước <span class="time">36 tháng</span>
							</div>
			...
			<div class="price-detail-showing">
				<div class="showing-title">
					...
					<div class="hrm-ref1">EASYHRM PREMIUM</div>
				</div>
				<div class="typeOfHrm center-row">
					<div>Đơn giá/ NLD/ Tháng</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="showing-detail">
							...
							<div class="type">
								Số lao động thực tế: <span class="time">10</span>
							</div>
							<div class="expired">
								Thời gian sử dụng: <span class="time">18 tháng</span> <br />
							</div>
					...
					<div class="col-md-4">
						<div class="showing-detail">
							...
							<div class="type">
								Số lao động thực tế: <span class="time">11 đến 50</span>
							</div>
							<div class="expired">
								Thời gian sử dụng: <span class="time">12 tháng</span> <br />
							</div>
							<button class="loadmore-btn" style="width: 80%">Tư vấn</button>
						</div>
					</div>
					<div class="col-md-4">
						<div class="showing-detail">
							...
							<div class="type">
								Số lao động thực tế: <span class="time">51 đến 100</span>
							</div>
							<div class="expired">
								Thời gian sử dụng: <span class="time">12 tháng</span> <br />
							</div>
					...
					<div class="note">
						<div class="note-text">
							(*) Chưa bao gồm phí khởi tạo: 1.000.000đ
						</div>
						<div class="note-text">
							(*) Quy mô trên 100 nhân sự sẽ được đề xuất khảo sát cụ thể
						</div>
					</div>
				</div>
			</div>
			<div class="price-detail-showing">
				<div class="showing-title" style="margin-bottom: 66px">
					<div class="showing-title-img">
						<img src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_30T07_20_52_362Z.png"
							alt="" />
					</div>
					<div class="hrm-ref1">EASYHRM HĐLĐ ĐIỆN TỬ</div>
				</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="showing-detail">
							<div class="specific-price">
								5.000 <span class="vnd">VNĐ</span>
							</div>
							<div class="type">
								Số lượng tài liệu: <span class="time">dưới 200</span>
							</div>
					...
					<div class="col-md-4">
						<div class="showing-detail">
							...
							<div class="type">
								Số lượng tài liệu: <span class="time">Từ 200 đến 1000</span>
							</div>
					...
					<div class="col-md-4">
						<div class="showing-detail">
							...
							<div class="type">
								Số lượng tài liệu: <span class="time">Trên 1000</span>
							</div>
							<button class="loadmore-btn" style="width: 80%">Tư vấn</button>
						</div>
					</div>
					<div class="note">
						<div class="note-text">
							(*) Chưa bao gồm phí bản quyền dịch vụ (áp dụng lần đầu):
							3.000.000đ
						</div>
						<div class="note-text">
							(*) Phí tích hợp dịch vụ & triển khai được báo giá theo giá khảo
							sát
						</div>
					</div>
				</div>
			...
			<div id="list_question">
				<div class="question-row">
					...
					<div class="the-answer">
						1. Sếp hãy bắt đầu quản trị nhân sự bằng việc sử dụng phần mềm
			...
			<div class="row">
				<div class="col-md-4">
					<div class="news-row">
						<div class="news-thumbnail">
							<img style="width: 100%"
								src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_31T02_30_39_053Z.png"
								alt="" />
						</div>
				...
				<div class="col-md-4">
					<div class="news-row">
						<div class="news-thumbnail">
							<img style="width: 100%"
								src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_31T02_30_42_762Z.png"
								alt="" />
						</div>
						<div class="news-release-date">28/08/2023</div>
						<div class="news-title">
				...
				<div class="col-md-4">
					<div class="news-row">
						<div class="news-thumbnail">
							<img style="width: 100%"
								src="https://easyhrm.vn/wp-content/uploads/2023/08/image_2023_08_31T02_30_51_963Z.png"
								alt="" />
						</div>
						<div class="news-release-date">28/08/2023</div>
						<div class="news-title">
		...
		<div class="container">
			<div class="row">
				<div class="footer-logo">
					<img src="https://easyhrm.vn/wp-content/uploads/2023/08/Layer_1.png" alt="" />
				</div>
				<div class="col-md-4">
					<div class="hrm-slogan">
						EASYHRM - GIẢI PHÁP NHÂN SỰ, BẢO HIỂM XÃ HỘI
					</div>
					<div class="contact-row">
						<div class="contact-icon">
							<img src="https://easyhrm.vn/wp-content/uploads/2023/08/tabler_map-pin-filled.png" alt="" />
						</div>
						<div class="contact-text">
							Trụ sở chính: Nhà khách ATS, số 8 Phạm Hùng, Phường Mễ Trì, Quận
							Nam Từ Liêm, Hà Nội
						</div>
					</div>
					<div class="contact-row">
						...
						<div class="contact-text">
							Chi nhánh: Số H.46 đường Dương Thị Giang, Phường Tân Thới Nhất,
							Quận 12, TP. Hồ Chí Minh
						</div>
					</div>
					<div class="contact-row">
						<div class="contact-icon">
							<img src="https://easyhrm.vn/wp-content/uploads/2023/08/majesticons_mail.png" alt="" />
						</div>
						<div class="contact-text">contact@easyhrm.vn</div>
					</div>
					<div class="contact-row">
						<div class="contact-icon">
							<img src="https://easyhrm.vn/wp-content/uploads/2023/08/mingcute_phone-fill.png" alt="" />
						</div>
						<div class="contact-text">
							<a href="tel: 1900561512">1900 56 15 12</a>
						</div>
					</div>
				</div>
				...
				<div class="col-md-3">
					<div class="footer-toc">
						<div class="hrm-slogan">MỤC LỤC</div>
						<!-- toc: table of content -->
						<div class="list-toc contact-text">
							<a href="">Sản phẩm</a>
						</div>
						<div class="list-toc contact-text">
							<a href=""> Khách hàng </a>
				...
				<div class="col-md-4">
					<div class="facebook-link">
						<!-- <img
				style="width: 100%"
				src="https://easyhrm.vn/wp-content/uploads/2023/08/Rectangle-185.png"
				alt=""
			  /> -->
						<div class="fb-page" data-href="https://www.facebook.com/profile.php?id=61550792211553"
							data-tabs="" data-width="" data-height="" data-small-header="false"
							data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
							<blockquote cite="https://www.facebook.com/profile.php?id=61550792211553"
								class="fb-xfbml-parse-ignore">
								<a href="https://www.facebook.com/profile.php?id=61550792211553">Easyhrm - Dễ dàng tự
									động hoá quản trị
									nhân sự</a>
							</blockquote>
						</div>
					...
					<div class="list-social-media">
						<div class="social-media">
							<a href="#"><img src="https://easyhrm.vn/wp-content/uploads/2023/08/Social-icon.png"
									alt="" /></a>
						</div>
						<div class="social-media">
							<a href="#"><img src="https://easyhrm.vn/wp-content/uploads/2023/08/Social-icon-1.png"
									alt="" /></a>
						</div>
						<div class="social-media">
							<a href="#"><img src="https://easyhrm.vn/wp-content/uploads/2023/08/Social-icon-2.png"
									alt="" /></a>
						</div>
						<div class="social-media">
							<a target="_blank" href="https://www.facebook.com/profile.php?id=61550792211553"><img
									src="https://easyhrm.vn/wp-content/uploads/2023/08/Social-icon-3.png" alt="" /></a>
						</div>
						<div class="social-media">
							<a href="#"><img src="https://easyhrm.vn/wp-content/uploads/2023/08/carbon_logo-youtube.png"
									alt="" /></a>
						</div>
					</div>
