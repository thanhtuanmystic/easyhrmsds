...
<section class="pi_banner">
    <div class="container">
        <div class="row center-row">
            <div class="col-md-6">
                <div class="pi_slogan">
                    EASYHRM BẢO HIỂM XÃ HỘI ĐIỆN TỬ
                </div>
                <div class="pi_subslogan">
                    Quản lý thủ tục BHXH tiện lợi <br>
                    trên nền tảng số, kết nối trực tiếp với <br>
                    BHXH Việt Nam nhanh chóng
                </div>
            ...
            <div class="col-md-6 slide-right">
                <img class="banner-picture-right"
                    src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_18T08_52_35_755Z.png" alt="" />
            </div>
...
<section id="esi_featured">
    ...
    <div class="esi_banner">
        <img style="width: 100%" src="https://easyhrm.vn/wp-content/uploads/2023/09/image_2023_09_18T09_28_31_287Z.png"
            alt="">
        <div class="row">
            <div class="col-md-6 esi_banner_text">
                EasyHRM BHXH đáp ứng chuẩn dữ liệu của BHXH Việt Nam <br>
                trong giao dịch điện tử, kết nối tiện lợi với <br>
                chữ ký số EasyCA
            </div>
        </div>
    </div>
    <div class="pi_features" style="background: rgba(254, 240, 233, 0.60);">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="sm_title-blue">
                        Quản lý, lưu trữ và tra cứu các loại <br>
    ...
    <div class="pi_features">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="sm_title-blue">
                        Kiểm soát thu, chi BHXH của doanh nghiệp <br>
    ...
    <div class="pi_features" style="background: rgba(254, 240, 233, 0.60);">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="sm_title-blue">
                        Nâng cao trải nghiệm BHXH điện tử của <br>
                        nhân viên, đảm bảo quyền lợi trong quá trình <br>
...
<section id="esi_form_register">
    <div class="esi_form_title">
        Trải nghiệm gói ưu đãi EasyHRM Standard <br>
        chỉ từ <span class="bahaiba">323</span>k/năm
    </div>
    <div class="esi_form_subtitle">
        Mua EasyHRM BHXH điện tử tặng ngay EasyHRM nhân sự
    </div>
    <div class="container">
        <div class="row center-row">
            <div class="col-md-6">
