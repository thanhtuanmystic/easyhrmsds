<?php
/* Template name: Đăng ký nhận tài liệu */ ?>
...
<section style="padding: 40px 0" id="">
    <div class="container">
        <h1 class="hrm-title">ĐĂNG KÝ NHẬN EBOOK "XÂY DỰNG THƯƠNG HIỆU TUYỂN DỤNG TRÊN FACEBOOK" </h1>
        <form action="../xu-ly-dang-ky-nhan-tai-lieu" method="POST" id="receive_document_form">
            <div class="row">
